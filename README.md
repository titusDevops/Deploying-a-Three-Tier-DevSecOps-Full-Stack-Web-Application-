...
**Deployed a secure and scalable three-tier web application on AWS EKS**, leveraging Docker and DevSecOps practices. Automated CI/CD pipelines with Jenkins, Trivy, and SonarQube to ensure vulnerability-free container images and maintain high code quality. Integrated static and container security scanning early in the development lifecycle, aligning with shift-left security principles. Implemented GitOps using ArgoCD for seamless, auditable deployments via Git repositories. Set up Prometheus and Grafana for real-time infrastructure and application monitoring with intuitive dashboards. Utilized Terraform for Infrastructure as Code, securely managing AWS services including ECR, S3, EC2, and DynamoDB for production-grade, policy-compliant deployments.
